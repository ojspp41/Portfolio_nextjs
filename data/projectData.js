    ...
    }, 
    {
        ...
        properties: {
            이름: {
                title: [
                    {
                        plain_text: "실리콘 실란트 카트리지 제조 공정에서 발생하는 인쇄 및 사출 불량을 실시간으로 탐지하는 AI 기반 불량 검출 시스템 개발 프로젝트입니다. CNN 기반 분류 모델을 활용해 산업 현장에 적용 가능한 정밀한 불량 탐지 모델을 구현했습니다. 딥러닝과 인공지능이라는 수업에서 회사와 협업하여 개발하였습니다"
                    }
                ]
            },
            요약: {
    ...
    },
    {
        ...
        properties: {
            이름: {
                title: [
                    {
                        plain_text: "직접 제품 상세페이지를 기획하고 촬영, 네이버 스마트스토어에 등록하여 마케팅 및 검색 키워드 최적화에 주력했습니다. 전반적인 운영을 1인으로 수행하며 월 평균 매출 300만 원 이상을 달성했습니다."
                    }
                ]
            },
            요약: {
